! function(t, e) { "function" == typeof define && define.amd && "function" == typeof require && "function" == typeof require.specified && require.specified("knockout") ? define(["jquery", "knockout"], e) : e(t.jQuery, t.ko) }(this, function(t, e) {
    ...
    void 0 !== e && e.bindingHandlers && !e.bindingHandlers.multiselect && (e.bindingHandlers.multiselect = {
        ...
        init: function(i, s, l, o, n) {
            ...
            if (l.has("value")) {
                var c = l.get("value");
                e.isObservable(c) && e.computed({ read: function() { c(), setTimeout(function() { a.multiselect("refresh") }, 1) }, disposeWhenNodeIsRemoved: i }).extend({ rateLimit: 100, notifyWhenChangesStop: !0 })
            }
            if (l.has("selectedOptions")) {
                var r = l.get("selectedOptions");
                e.isObservable(r) && e.computed({ read: function() { r(), setTimeout(function() { a.multiselect("refresh") }, 1) }, disposeWhenNodeIsRemoved: i }).extend({ rateLimit: 100, notifyWhenChangesStop: !0 })
            }
            var u = function(t) { setTimeout(function() { t ? a.multiselect("enable") : a.multiselect("disable") }) };
            if (l.has("enable")) {
                var d = l.get("enable");
                e.isObservable(d) ? e.computed({ read: function() { u(d()) }, disposeWhenNodeIsRemoved: i }).extend({ rateLimit: 100, notifyWhenChangesStop: !0 }) : u(d)
            }
            if (l.has("disable")) {
                var b = l.get("disable");
                e.isObservable(b) ? e.computed({ read: function() { u(!b()) }, disposeWhenNodeIsRemoved: i }).extend({ rateLimit: 100, notifyWhenChangesStop: !0 }) : u(!b)
            }
            e.utils.domNodeDisposal.addDisposeCallback(i, function() { a.multiselect("destroy") })
        },
        ...
        defaults: {
            ...
            checkboxName: function(t) { return !1 },
        ...
        buildDropdownOptions: function() {
            this.$select.children().each(t.proxy(function(e, i) {
            ...
            }, this)), t("li a", this.$ul).on("mousedown", function(t) { if (t.shiftKey) return !1 }), t(this.$ul).on("touchstart click", "li a", t.proxy(function(e) {
                e.stopPropagation();
                var i = t(e.target);
                ...
                var i = t(e.target).closest("li").nextUntil("li.multiselect-group").not(".multiselect-filter-hidden"),
                    s = !0;
                i.each(function() { s = s && !t(this).hasClass("multiselect-collapsible-hidden") }), s ? i.hide().addClass("multiselect-collapsible-hidden") : i.show().removeClass("multiselect-collapsible-hidden")
        ...
        buildReset: function() {
            if (this.options.includeResetOption) {
                ...
                this.options.enableHTML ? t("a", e).html(this.options.resetText) : t("a", e).text(this.options.resetText), t("a", e).click(t.proxy(function() { this.clearSelection() }, this)), this.$ul.prepend(e)
            }
        },
            ...
            if (this.options.enableFiltering || this.options.enableCaseInsensitiveFiltering) {
                ...
                if (this.$select.find("option").length >= e) {
                    if (this.$filter = t(this.options.templates.filter), t("input", this.$filter).attr("placeholder", this.options.filterPlaceholder), this.options.includeFilterClearBtn) {
                        ...
                        i.on("click", t.proxy(function(e) { clearTimeout(this.searchTimeout), this.query = "", this.$filter.find(".multiselect-search").val(""), t("li", this.$ul).show().removeClass("multiselect-filter-hidden"), this.updateSelectAll(), this.options.enableClickableOptGroups && this.options.multiple && this.updateOptGroups() }, this)), this.$filter.find(".input-group").append(i)
                    }
        ...
        destroy: function() { this.$container.remove(), this.$select.show(), this.$select.prop("disabled", this.options.wasDisabled), this.$select.data("multiselect", null) },
        refresh: function() {
            var e = {};
            t("li input", this.$ul).each(function() { e[t(this).val()] = t(this) }), t("option", this.$select).each(t.proxy(function(i, s) {
                var l = t(s),
                    o = e[t(s).val()];
        ...
        dataprovider: function(e) {
            ...
            t.each(e, function(e, l) {
                var o;
                if (t.isArray(l.children)) i++, o = t("<optgroup/>").attr({ label: l.label || "Group " + i, disabled: !!l.disabled, value: l.value }),
                    function(t, e) { for (var i = 0; i < t.length; ++i) e(t[i], i) }(l.children, function(e) {
                    ...
                    var n = { value: l.value, label: l.label || l.value, title: l.title, class: l.class, selected: !!l.selected, disabled: !!l.disabled };
        ...
        updateOptGroups: function() {
            ...
            e.each(function() {
                var e = t(this).nextUntil("li.multiselect-group").not(".multiselect-filter-hidden").not(".disabled"),
                    s = !0;
                e.each(function() { t("input", this).prop("checked") || (s = !1) }), i && (s ? t(this).addClass(i) : t(this).removeClass(i)), t("input", this).prop("checked", s)
            })
        },
        ...
        getInputByValue: function(e) { for (var i = t("li input:not(.multiselect-search)", this.$ul), s = e.toString(), l = 0; l < i.length; l += 1) { var o = i[l]; if (o.value === s) return t(o) } },
